...
def load_config(testing: bool):
    section = "aw-watcher-session" + ("-testing" if testing else "")
    return load_config_toml("aw-watcher-session", default_config)[section]
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="A Windows session-state watcher for ActivityWatch."
    )
